...
Forked from Tytan652 and refactored to support FFmpeg 9.0/9.0.1 and the latest NDI 6.3.x version.
...
git clone -b n9.0 https://git.ffmpeg.org/ffmpeg.git
cd ffmpeg

# Apply the patch

patch -Np1 -i ../ffmpeg-ndi-patch/ffmpeg_9.0-add_ndi.patch
