...
Forked from Tytan652 and refactored to support FFmpeg 8.0 and the latest NDI 6.2.0 version.
...
git clone -b n8.0 https://git.ffmpeg.org/ffmpeg.git
cd ffmpeg

# Apply the patch

patch -Np1 -i ../ffmpeg-ndi-patch/ffmpeg_8.0-add_ndi.patch
